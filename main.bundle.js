...
var FavoritesComponent = /** @class */ (function () {
    ...
    FavoritesComponent.prototype.getList = function () {
        ...
        this.favService.GetFavorite(kidId).subscribe(function (data) {
            ...
            for (var index = 0; index < _this.Favorites.length; index++) {
                ...
                favVideoArr = [_this.videoURL(_this.Favorites[index].formats, _this.Favorites[index].id)];
                temp.push(subCard);
                videoTemp.push(favVideoArr);
            }
            _this.FavVideo = temp;
            console.log(_this.FavVideo);
            _this.FavVideoArray = videoTemp;
            console.log(_this.FavVideoArray);
        }, function (Error) {
            _this.spinnerService.hide();
        });
    };
    FavoritesComponent.prototype.videoURL = function (FormateIds, id) {
        var url = localStorage.getItem('videoUrl');
        this.innerheigth = window.innerHeight;
        if (this.innerheigth >= 720) {
            var formateArray = FormateIds.filter(function (x) { return x.id == 3; });
            var index = FormateIds.findIndex(function (a) { return a.id == 3; });
            if (index > -1) {
            ...
            var formateArray = FormateIds.filter(function (x) { return x.id == 6; });
            var index = FormateIds.findIndex(function (a) { return a.id == 6; });
            if (index > -1) {
                var ID = FormateIds[index].id;
                this.bucketName = '.mp4';
                var VideoUrl = url + ID + '/' + id + this.bucketName;
            ...
            var formateArray = FormateIds.filter(function (x) { return x.id == 7; });
            var index = FormateIds.findIndex(function (a) { return a.id == 7; });
            if (index > -1) {
                var ID = FormateIds[index].id;
                this.bucketName = '.mp4';
                var VideoUrl = url + ID + '/' + id + this.bucketName;
            ...
            var formateArray = FormateIds.filter(function (x) { return x.id == 8; });
            var index = FormateIds.findIndex(function (a) { return a.id == 8; });
            if (index > -1) {
                var ID = FormateIds[index].id;
                this.bucketName = '.mp4';
                var VideoUrl = url + ID + '/' + id + this.bucketName;
    ...
    FavoritesComponent.prototype.nextVideo = function () {
    ...
    FavoritesComponent.prototype.deleteFav = function (id) {
        ...
        remove.videoId = id;
        this.spinnerService.show();
        var index = this.FavVideo.findIndex(function (a) { return a[0].id == id; });
...
var VideoSelectionComponent = /** @class */ (function () {
    function VideoSelectionComponent(route, videoService, favService, timerService, router, spinnerService) {
        ...
        this.router = router;
        this.spinnerService = spinnerService;
        this.FavouriteBtnSrc = "assets/svgs/like.svg";
        this.FavouriteBtnText = "Favorite";
        this.isPlaying = false;
        this.videoIndex = 0;
        this.videoArray = [];
        this.video = [];
    ...
    VideoSelectionComponent.prototype.getSubCard = function () {
        ...
        this.videoService.GetSubCard(this.idss).subscribe(function (data) {
            ...
            var arrayTemp = [];
            for (var index = 0; index < _this.cards.length; index++) {
                subCard = [{ 'id': _this.cards[index].id, 'duration': _this.cards[index].duration, 'imgUrl': _this.VideoImageUrl(_this.cards[index].id), 'Title': _this.cards[index].title }];
                subCardArray = [_this.videoURL(_this.cards[index].formats, _this.cards[index].id)];
                temp.push(subCard);
            ...
            _this.videoArray = arrayTemp;
            console.log(_this.videoArray);
            _this.videoItem = _this.videoArray[_this.videoIndex];
            console.log(_this.videoItem);
        }, function (Error) {
            _this.spinnerService.hide();
        });
    };
    VideoSelectionComponent.prototype.videoURL = function (FormateIds, id) {
        var url = localStorage.getItem('videoUrl');
        this.innerheigth = window.innerHeight;
        if (this.innerheigth >= 720) {
            var formateArray = FormateIds.filter(function (x) { return x.id == 3; });
    ...
    VideoSelectionComponent.prototype.addToFav = function (id) {
        ...
        this.spinnerService.show();
        var index = this.video.findIndex(function (a) { return a[0].id == id; });
        console.log(index);
    ...
    VideoSelectionComponent.prototype.IsFavourite = function (id) {
        // let data = this.vid
        var index = this.FavouritesArray.findIndex(function (a) { return a == id; });
        if (index > -1) {
            return true;
        }
        else {
    ...
    VideoSelectionComponent.prototype.nextVideo = function () {
